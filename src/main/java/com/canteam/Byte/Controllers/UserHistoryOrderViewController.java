...
public class UserHistoryOrderViewController implements Initializable {
    ...
    void onCloseBtnClicked(ActionEvent event) {
        pageNavigator.navigateToPage(closeBtn, "UserHistoryOrderList");
    }
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        ArrayList<Document> userOrders = OrderModel.getUserOrdersHistory(UserModel.getUserName());
